...
def main(cfg, args):
    ...
    with torch.no_grad():
        ...
        for path in tqdm(paths):
            ...
            np.save(f'{args.ident_save_folder}/identity', code[0].cpu().numpy())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ident_save_folder', default="/cfs/xiaolu/code/gs_avatar/IMavatar/preprocess/datasets/xk", type=str)
    parser.add_argument('-i', default='/cfs/xiaolu/code/gs_avatar/IMavatar/preprocess/datasets/xk/source/00001.png', type=str, help='Input folder with images')
    parser.add_argument('-o', default='/cfs/xiaolu/code/gs_avatar/IMavatar/preprocess/datasets/xk/mica_output', type=str, help='Output folder')
    parser.add_argument('-a', default='/cfs/xiaolu/code/gs_avatar/IMavatar/preprocess/datasets/xk/arcface', type=str, help='Processed images for MICA input')
    parser.add_argument('-m', default='/cfs/xiaolu/code/gs_avatar/IMavatar/preprocess/submodules/MICA/data/pretrained/mica.tar', type=str, help='Pretrained model path')
