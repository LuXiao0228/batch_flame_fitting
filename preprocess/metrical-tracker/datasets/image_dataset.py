...
class ImagesDataset(Dataset):
    ...
    def initialize(self):
        ...
        self.images = sorted(glob(os.path.join(self.source, 'images', '*.png')))
    ...
    def __getitem__(self, index):
        ...
        lmk_path = imagepath.replace('images', 'lmk_kpt').replace('.png', '.npy').replace('.jpg', '.npy')
        lmk_path_dense = imagepath.replace('images', 'lmk_kpt_dense').replace('.png', '.npy').replace('.jpg', '.npy')
